  ...
  return (
    <div>
      <Button onClick={handleOpen}>
        <div className="depositbutton h-11 w-32 flex items-center justify-center bg-[#004526] text-white hover:bg-green-900 capitalize font-medium text-base">Deposit</div>
      </Button>
      <Modal
        open={open}
        onClose={handleClose}
            ...
            <div className="w-full items-center gap-x-5">
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mt-3">
                ...
                <div className="flex justify-end gap-2 w-full lg:w-1/2 px-2">
                  ...
                  <button
                    className="cursor-pointer w-full lg:w-1/4 px-2 h-10 bg-green-700 text-white text-lg hover:bg-green-900 transition duration-200 transform hover:scale-105 flex justify-center items-center gap-x-2"
                    onClick={handleJackpotDeposit}
                  >
                    Deposit ${totalPrice.toFixed(2)}
                    <span className="text-xs block md:hidden">Click Here To Submit</span>
                  </button>
                  <button
    ...
    >
      ...
      >
        ...
        {/* Description */}
        <Typography id="trade-modal-description" sx={{ mb: 4 }}>
